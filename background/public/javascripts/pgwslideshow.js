...
;(function($){
    ...
    $.fn.pgwSlideshow = function(options) {
        ...
        var setup = function() {
            ...
            pgwSlideshow.plugin.prepend('<div class="ps-current"><ul class="allImgsList"></ul><span class="ps-caption"></span></div>');
            ...
            pgwSlideshow.plugin.find('.ps-list > ul > li').each(function() {
                ...
                //做到这
                if (element.image) {
                    // currentElement.html('<a href="'+element.image+'" class="aImg"><img src="' + element.image + '" alt="' + (element.title ? element.title : '') + '"></a>');
                    currentElement.html("<img src='"+ element.image +"'>");
                } else if (element.thumbnail) {
                    // currentElement.html('<a href="'+element.image+'" class="aImg"><img src="' + element.thumbnail + '" alt="' + (element.title ? element.title : '') + '"></a>');
                    currentElement.html("<img src='"+ element.thumbnail +"'>");
                }
